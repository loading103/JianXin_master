...
public class ImTextRender {
    ...
    static {
        ...
        FACE_WIDTH = IMDensityUtil.dip2px(BaseApplication.getContext(),20);
        VIDEO_FACE_WIDTH = IMDensityUtil.dip2px(BaseApplication.getContext(),16);
    ...
    public static CharSequence getFaceImageSpan(String content, int imgRes) {
        ...
        Drawable faceDrawable = ContextCompat.getDrawable(BaseApplication.getContext(), imgRes);
